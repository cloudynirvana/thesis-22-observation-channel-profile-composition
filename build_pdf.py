...
<head>
<meta charset="utf-8"/>
<title>Thesis #22. Composition of named observation channels into a Disease Profile</title>
<style>
@page {{
  size: A4;
  margin: 22mm 20mm 24mm 20mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #22. Computational research only. Not a medical device. " counter(page);
    font-size: 8.5pt;
    color: #444;
